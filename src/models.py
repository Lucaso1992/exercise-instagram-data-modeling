...
class User(Base):
    ...
    relation_post= relationship("Post", backref="user", lazy=True)
    relation_follower = relationship("Follower", backref="user", lazy=True)
    relation_comment = relationship("Comment", backref="user", lazy=True)
